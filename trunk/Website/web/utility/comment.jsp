        ...
        <div style="padding-top:0px;">
            <div style="padding-top:10px; width:476px; background-color:#ffffff">
                <div style="padding-bottom:5px; overflow:hidden;">
                    <div style="width:60%">
                        <input type="text" value="H? tên" name="customerName" style="width:280px;" size="29" onfocus="NameOnFocus(this)" onblur="NameOnBlur(this)" onkeyup="initTyper(this)">
                    </div>
                ...
                <div style="overflow:hidden;">
                    <div style="width:60%">
                        <input type="submit" value="G?i Toà so?n" name="B1">
                        <input type="button" value="Xoá tr?ng" name="B2" onclick="InputDefault();">
...
<script type="text/javascript">
    ...
    {
        if(field.value=='H? tên'){ field.value = '';}
    }

    function NameOnBlur(field)
    {
        if(field.value==''){ field.value='H? tên';}
    }
